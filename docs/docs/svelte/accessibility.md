---
title: Accessible Svelte Skeleton Loading
description: Build accessible Svelte skeleton loading states with Skelia using aria-busy, aria-live, and hidden decorative placeholders.
---
...
```svelte
<script lang="ts">
  import { Skeleton, SkeletonLine } from "@skelia/svelte";
</script>
